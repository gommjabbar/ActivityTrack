...
namespace ActivityTrack.Controllers
{
    public class ActivityTypeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type,Description")] ActivityType activityType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type,Description")] ActivityType activityType)
        {
            if (ModelState.IsValid)
            {
